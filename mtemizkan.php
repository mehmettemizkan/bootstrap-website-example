...
<head>
  <meta charset="utf-8">
  <title>Mehmet Temizkan</title>
  <meta name="description" content="Bootstrap4 Örnek Sayfası">
  <meta name="keywords" content="mehmet temizkan, bootstrap4 ornek sayfa, html, css, php">
  <meta name="author" content="Mehmet Temizkan">
...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-danger">
    <div class="container">
      <a href="#" class="navbar-brand">MEHMET TEMİZKAN</a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#menue">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse" id="menue">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item ">
            <a href="#" class="nav-link active"><i class="fa fa-home" aria-hidden="true"></i> ANASAYFA</a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">MATEMATİK</a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">BİLGİSAYAR</a>
          </li>
          <li class="nav-item">
            <a href="hakkimda.html" class="nav-link"> HAKKIMDA <i class="fa fa-address-card"></i></a>
          </li>
        </ul>
      </div>      
    </div>
  ...
  <div class="container">
    <div class="row mt-4">
      <div class="col-md-8">
        <h1 style="text-align: center;" >Makaleler</h1>
        <hr class="bg-success">    
        <div class="card mb-4">
          <img class="card-img-top" src="html5.png" width="750" height="300">
          <div class="card-body">
            <h2>HTML5</h2>
            <p class="card-text">
              ...
              <span id="more">
                ...
                Ses veya film etiketleri gibi birçok özellikli yönleriyle birlikte kullanılması gereken HTML5, sadece bir şekilleme dili olmaktan ziyade Web uygulamaları yazmakta da kullanılabilmektedir. CSS3 ve JavaScript ile birleştirerek çok daha güçlü, uyumlu ve sağlam uygulamaları yapmak mümkündür. Uygulamalar, bu sayede binlerce cihazda birçok ihtimale uygun şekilde kullanılabilmektedir. Özellikle de iliştirilmiş platformlar ve bağlanmış cihazlarla çok daha güçlü olacaklardır. <br> Kaynak: <a href="https://tr.wikipedia.org/wiki/HTML5">https://tr.wikipedia.org/wiki/HTML5</a>
              </span>
            </p>
            <button class="btn btn-success" onclick="myFunction()" id="myBtn">Devamını Oku</button>
          </div>
          <div class="card-footer text-muted">
            <span>Yayınlandığı Tarih: 13.12.2020 16:00</span>
          </div>
        </div>

        <div class="card mb-4">
          <img class="card-img-top" src="css3.jpg" width="750" height="300">
          <div class="card-body">
            <h2>CSS</h2>
            <p>Cascading Style Sheets (Basamaklı Stil Şablonları ya da Basamaklı Biçim Sayfaları, bilinen kısa adıyla CSS), HTML'e ek olarak metin ve format biçimlendirme alanında fazladan olanaklar sunan bir işaretleme dilidir.
              ...
              <span id="demo" class="collapse">
                ...
                CSS kodları, HTML kodlarının içine yazılabildiği gibi harici bir CSS dosyası oluşturularak da işlem yaptırılabilir. Ayrıntılı bilgiye ulaşmak için <a href="https://tr.wikipedia.org/wiki/CSS">tıklayın.</a>
              </span>
            </p>
            <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">Devamını Oku</button>
          </div>          
          <div class="card-footer text-muted">
            <span>Yayınlandığı Tarih: 13.12.2020 20:00</span>
          </div>
        </div>

        <div class="card mb-4">
          <img class="card-img-top" src="php.png" width="750" height="300">
          <div class="card-body">
            <h2 class="card-title">PHP</h2>
            <p>PHP : Hypertext Preprocessor (Türkçe: Üstünyazı Önişlemcisi) (Aslen: Personal Home Page - Kişisel Ana Sayfa) , internet için üretilmiş, sunucu taraflı, çok geniş kullanımlı, genel amaçlı, içerisine HTML gömülebilen betik ve programlama dilidir. İlk kez 1995 yılında Rasmus Lerdorf tarafından yaratılan PHP'nin geliştirilmesi bugün PHP topluluğu tarafından sürdürülmektedir. Ocak 2013 itibarıyla 244 milyondan fazla web sitesi PHP ile çalışırken 2.1 milyon web sunucusunda PHP kurulumu bulunmaktadır
              <span id="demo" class="collapse">
                ...
                <a href="https://tr.wikipedia.org/wiki/PHP">https://tr.wikipedia.org/wiki/PHP</a>
              </span> 
            </p>
              <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">Devamını Oku</button>
            </div>
        ...
        <div class="col-md-4">
         <div class="card">
          <h6 class="card-header bg-info text-white">Arama Kutusu</h6>
          <div class="card-body">
            <div class="input-group">
              <input type="text" class="form-control" placeholder="Kelime Giriniz..." name="">
              <button class="btn btn-secondary" type="button">Ara</button></span>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <ul class="list-unstyled">
                  <li>
                    <a href="#"><i class="fa fa-html5" aria-hidden="true"></i>HTML5</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-css3" aria-hidden="true"></i>CSS3</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-home" aria-hidden="true"></i>Bootstrap4</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-home" aria-hidden="true"></i>PHP</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-home" aria-hidden="true"></i>Java</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-home" aria-hidden="true"></i>Ajax</a>
                  </li>
                </ul>
              </div>
              ...
              <div class="col-md-6">
                <ul class="list-unstyled">
                  <li>
                    <a href="#"><i class="fa fa-code"></i>Matlab</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-home" aria-hidden="true"></i>Maple</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-home" aria-hidden="true"></i>Haskell</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-home" aria-hidden="true"></i>R</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-home" aria-hidden="true"></i>Gap</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-home" aria-hidden="true"></i>GeoGebra</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="card my-4">
          <h6 class="card-header bg-info text-white">Reklam Alanı</h6>
          <div align="center" class="card-body">
            <img class="img-fluid" src="http://via.placeholder.com/400x800" alt="Reklam Alanı">
          </div>
        </div>    
            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="altmenuac">
               ...
               <ul class="navbar-nav ml-auto">
                 ...
                 <li class="nav-item">
                   <a href="#" class="nav-link">Koşullar ve Şartlar</a>
                 </li>
               </ul>
             </div>
           </div>
